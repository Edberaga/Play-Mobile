...
<nav class="navbar navbar-expand-md navbar-dark bg-dark px-3">
    ...
    <main>
      ...
      //if the value email existed, this function will executed.
      if(isset($_SESSION['email'])) 
      {
        if((time() - $_SESSION['time']) > 900 ) //After afk for 15 minutes it will automatically logout.
        {
          //supposedly if the time is already more than 15 secound. It will lead to logout.php,
          header('location:logout.php');
        }
        else
        {
          //During in the session, the time will be displayed.
          $_SESSION['time'] = time();
      ...
      ?>
      <a href="logout.php"><p class="text-center text-decoration-none text-dark">Logout</p></a>
    </main>
